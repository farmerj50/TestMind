...
console.log(`[worker] boot: queue=%s redis=%s`, QUEUE_NAME, REDIS_URL);
...
worker.on('ready', () => console.log('[worker] ready on queue', QUEUE_NAME));
worker.on('error', (e) => console.error('[worker] connection error', e));
