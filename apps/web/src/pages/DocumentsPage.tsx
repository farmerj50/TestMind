...
const sections = [
  ...
  },
  {
    ...
    summary:
      "Configure how the security scanner authenticates before running OWASP/API checks. Enterprise mode is for apps you own and can automate; External Security Assessment mode is for authorized targets where you must log in by hand.",
    highlights: [
    ...
    steps: [
      "Pick a project, then under Authentication Mode choose Enterprise / My Application or External Security Assessment.",
