          ...
          <CardContent className="space-y-2 text-sm text-slate-700">
            ...
            {failureReasons.length > 0 && (
              <div className="rounded-md border border-slate-200">
                <div className="grid grid-cols-3 bg-slate-50 px-3 py-2 text-xs font-medium text-slate-600">
                  <div>Reason</div>
                ...
                <div className="divide-y">
                  {failureReasons.map((r) => (
                    <div key={r.label} className="grid grid-cols-3 px-3 py-2 text-xs text-slate-700">
