...
test("Chime — ensure loading screen is responsive", async ({ page }, testInfo: TestInfo) => {
  test.info().annotations.push({ type: "parentSuite", description: "Testmind Generated Suite" }, { type: "suite", description: "/" }, { type: "story", description: "Chime — ensure loading screen is responsive" }, { type: "parameter", description: "page=/" });
  ...
  await test.step("1. Run custom step", async () => {
    ...
    // TODO: custom step
      ...
      await captureStepArtifact(page, testInfo, "1. Run custom step");
    }
  });
  ...
  await test.step("3. Run custom step", async () => {
    ...
    // TODO: custom step
      ...
      await captureStepArtifact(page, testInfo, "3. Run custom step");
    }
  });
  ...
  await test.step("5. Run custom step", async () => {
    ...
    // TODO: custom step
      ...
      await captureStepArtifact(page, testInfo, "5. Run custom step");
    }
  });
  ...
  await test.step("7. Run custom step", async () => {
    try {
    // TODO: custom step
    } finally {
      await captureStepArtifact(page, testInfo, "7. Run custom step");
    }
  });
});
