...
test("eToro — verify login form accessibility", async ({ page }, testInfo: TestInfo) => {
  test.info().annotations.push({ type: "parentSuite", description: "Testmind Generated Suite" }, { type: "suite", description: "/home" }, { type: "story", description: "eToro — verify login form accessibility" }, { type: "parameter", description: "page=/home" });
