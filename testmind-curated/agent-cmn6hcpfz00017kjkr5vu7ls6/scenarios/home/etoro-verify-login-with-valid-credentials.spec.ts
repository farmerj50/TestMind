...
test("eToro — verify login with valid credentials", async ({ page }, testInfo: TestInfo) => {
  test.info().annotations.push({ type: "parentSuite", description: "Testmind Generated Suite" }, { type: "suite", description: "/home" }, { type: "story", description: "eToro — verify login with valid credentials" }, { type: "parameter", description: "page=/home" });
