...
test("eToro — verify password field masking", async ({ page }, testInfo: TestInfo) => {
  test.info().annotations.push({ type: "parentSuite", description: "Testmind Generated Suite" }, { type: "suite", description: "/home" }, { type: "story", description: "eToro — verify password field masking" }, { type: "parameter", description: "page=/home" });
