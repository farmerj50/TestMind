...
test("Landing - verify footer or secondary content remains reachable", async ({ page }, testInfo: TestInfo) => {
  test.info().annotations.push({ type: "parentSuite", description: "Testmind Generated Suite" }, { type: "suite", description: "/" }, { type: "story", description: "Landing - verify footer or secondary content remains reachable" }, { type: "parameter", description: "page=/" });
