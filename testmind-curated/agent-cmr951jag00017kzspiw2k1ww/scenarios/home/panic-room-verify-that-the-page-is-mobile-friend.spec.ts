...
test("Panic Room — verify that the page is mobile-friendly", async ({ page }, testInfo: TestInfo) => {
  test.info().annotations.push({ type: "parentSuite", description: "Testmind Generated Suite" }, { type: "suite", description: "/" }, { type: "story", description: "Panic Room — verify that the page is mobile-friendly" }, { type: "parameter", description: "page=/" });
