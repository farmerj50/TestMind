...
test("Panic Room — verify that the page does not have any JavaScript errors", async ({ page }, testInfo: TestInfo) => {
  test.info().annotations.push({ type: "parentSuite", description: "Testmind Generated Suite" }, { type: "suite", description: "/" }, { type: "story", description: "Panic Room — verify that the page does not have any JavaScript errors" }, { type: "parameter", description: "page=/" });
