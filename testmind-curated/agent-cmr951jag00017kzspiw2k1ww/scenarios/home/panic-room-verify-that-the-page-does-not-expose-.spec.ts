...
test("Panic Room — verify that the page does not expose sensitive information", async ({ page }, testInfo: TestInfo) => {
  test.info().annotations.push({ type: "parentSuite", description: "Testmind Generated Suite" }, { type: "suite", description: "/" }, { type: "story", description: "Panic Room — verify that the page does not expose sensitive information" }, { type: "parameter", description: "page=/" });
