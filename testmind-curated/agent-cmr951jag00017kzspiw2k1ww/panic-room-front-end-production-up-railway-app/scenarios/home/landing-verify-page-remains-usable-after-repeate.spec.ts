...
test("Landing - verify page remains usable after repeated load", async ({ page }, testInfo: TestInfo) => {
  test.info().annotations.push({ type: "parentSuite", description: "Testmind Generated Suite" }, { type: "suite", description: "/" }, { type: "story", description: "Landing - verify page remains usable after repeated load" }, { type: "parameter", description: "page=/" });
