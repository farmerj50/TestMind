...
test("Panic Room — verify landing page loads successfully", async ({ page }, testInfo: TestInfo) => {
  test.info().annotations.push({ type: "parentSuite", description: "Testmind Generated Suite" }, { type: "suite", description: "/" }, { type: "story", description: "Panic Room — verify landing page loads successfully" }, { type: "parameter", description: "page=/" });
