...
test("Panic Room — verify no mixed content warnings", async ({ page }, testInfo: TestInfo) => {
  test.info().annotations.push({ type: "parentSuite", description: "Testmind Generated Suite" }, { type: "suite", description: "/" }, { type: "story", description: "Panic Room — verify no mixed content warnings" }, { type: "parameter", description: "page=/" });
