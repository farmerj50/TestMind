...
test("Landing - verify primary call-to-action path remains available", async ({ page }, testInfo: TestInfo) => {
  test.info().annotations.push({ type: "parentSuite", description: "Testmind Generated Suite" }, { type: "suite", description: "/" }, { type: "story", description: "Landing - verify primary call-to-action path remains available" }, { type: "parameter", description: "page=/" });
