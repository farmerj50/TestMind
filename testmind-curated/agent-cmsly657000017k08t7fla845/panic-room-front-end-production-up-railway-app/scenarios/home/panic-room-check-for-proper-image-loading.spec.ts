...
test("Panic Room — check for proper image loading", async ({ page }, testInfo: TestInfo) => {
  test.info().annotations.push({ type: "parentSuite", description: "Testmind Generated Suite" }, { type: "suite", description: "/" }, { type: "story", description: "Panic Room — check for proper image loading" }, { type: "parameter", description: "page=/" });
