...
test("Panic Room — test for XSS vulnerabilities", async ({ page }, testInfo: TestInfo) => {
  test.info().annotations.push({ type: "parentSuite", description: "Testmind Generated Suite" }, { type: "suite", description: "/" }, { type: "story", description: "Panic Room — test for XSS vulnerabilities" }, { type: "parameter", description: "page=/" });
