...
test("Panic Room — ensure no console errors on landing page", async ({ page }, testInfo: TestInfo) => {
  test.info().annotations.push({ type: "parentSuite", description: "Testmind Generated Suite" }, { type: "suite", description: "/" }, { type: "story", description: "Panic Room — ensure no console errors on landing page" }, { type: "parameter", description: "page=/" });
