...
// Auto-generated for page /manual/regression-landing-page 1 test(s)

test("Regression | Landing page", async ({ page }) => {
  test.info().annotations.push({ type: "parentSuite", description: "Testmind Generated Suite" }, { type: "suite", description: "/manual/regression-landing-page" }, { type: "story", description: "Regression | Landing page" }, { type: "parameter", description: "page=/manual/regression-landing-page" });
  await test.step("1. Ensure text \"Review Landing page\" is visible", async () => {
    {
      const rawText = "Review Landing page";
      if (/justicepath/i.test(rawText) && "/manual/regression-landing-page" !== "/") {
        await ensurePageIdentity(page, "/manual/regression-landing-page");
        return;
      }
      if (rawText.trim().toLowerCase() === "page") {
        await expect(page).toHaveURL(pathRegex("/manual/regression-landing-page"), { timeout: 15000 });
        await ensurePageIdentity(page, "/manual/regression-landing-page");
        return;
      }
